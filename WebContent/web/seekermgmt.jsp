...
<table border="3" width="100%" bordercolor="#1AA4FF">
	<tr>
		<td align="center"><b><font color="#003559" face="Bell MT">Name</font></b></td>
        ...
        %>
	<tr>
		<td align="center"><b><font face="Calibri" size="2"><%=lname%>&nbsp;<%=fname%></font></b></td>
		<td align="center"><b><font face="Calibri" size="2">
                <a style="text-decoration: none" href="viewseeker.jsp?uid=<%=uid%>"><font color="#000000">View</font></a>/<a style="text-decoration: none" href="delseeker.jsp?uid=<%=uid%>" onclick="return confirmsubmit()"><font color="#000000">Delete</font></a></font></b></td>
	</tr>
         <% 
         }
         %>
